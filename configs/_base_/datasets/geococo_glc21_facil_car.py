...
data = dict(
    ...
    train=dict(
        ...
        '/nas/Dataset/RSI_CL_GLC21/geococo/facilities_car/GeoCOCO_CLS/v1_2/GeoCOCO_Train/',
    ...
    val=dict(
        type=dataset_type,
        data_prefix=  # noqa E251
        '/nas/Dataset/RSI_CL_GLC21/geococo/facilities_car/GeoCOCO_CLS/v1_2/GeoCOCO_Val/',
        ann_file='GeoCOCO.json',
