...
data = dict(
    ...
    train=dict(
        type='GeoCOCODataset',
        data_prefix='/nas/k8s/dev/mlops/dataset-artifacts/glc21a/CLS/'
        'running_car/version_2/GeoCOCO_Train',
    ...
    val=dict(
        type='GeoCOCODataset',
        data_prefix='/nas/k8s/dev/mlops/dataset-artifacts/'
        'glc21a/CLS/running_car/version_2/GeoCOCO_Val',
        ann_file='GeoCOCO.json',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='RandomResizedCrop', size=(64, 64), scale=(1.0, 1.0)),
